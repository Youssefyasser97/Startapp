...
$sql= "SELECT start_date ,COUNT(start_date) AS number_of_bookings , SUM(paymentamount) AS total_amount
FROM Reservations
GROUP BY start_date
...
<body>
    ...
    <div>
    <div class="dropdown">
<button onclick="myFunction()" class="dropbtn">Choose a financial option</button>

  <div id="myDropdown" class="dropdown-content">
     <a href="#">financialoption1</a>
    <a href="#">financialoption2</a>
    <a href="#">financialoption3</a>
    <a href="#">financialoption4</a>
    <a href="#">financialoption5</a>
  </div>
</div>
