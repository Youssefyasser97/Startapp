...
// echo $row[4]; // or echo $row[1]
// echo $row['UID']; // or echo $row[1]
...
<button onclick="myFunction()" class="dropbtn">Choose a booking type</button>
 ...
 <a href="https://www.ydawood.com/bookcoworking/before.php">Coworking Space</a>
